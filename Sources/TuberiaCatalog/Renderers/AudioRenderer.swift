...
public struct AudioRenderer: Renderer, Sendable {
  ...
  public func render(_ input: DecodedOutput) throws -> RenderedOutput {
    ...
    let wavData = buildWAV(
      samples: samples, sampleRate: sampleRate, bitsPerSample: 16, numChannels: 1)
  ...
  private func buildWAV(samples: [Int16], sampleRate: Int, bitsPerSample: Int, numChannels: Int)
    -> Data
  {
