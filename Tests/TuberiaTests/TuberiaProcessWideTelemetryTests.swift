...
struct TuberiaProcessWideTelemetryTests {
    ...
    @Test("No instance reporter + process-wide reporter set → emissions reach the process-wide reporter")
    ...
    @Test("Real DiffusionPipeline generate() emits pipeline lifecycle events via process-wide reporter")
