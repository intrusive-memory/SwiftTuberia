...
struct CatalogRegistrationTests {
    ...
    func huggingFaceRepoLookup() {
        ...
        #expect(registry.huggingFaceRepo(for: "t5-xxl-encoder-int4") == "intrusive-memory/t5-xxl-int4-mlx")
        #expect(registry.huggingFaceRepo(for: "sdxl-vae-decoder-fp16") == "intrusive-memory/sdxl-vae-fp16-mlx")
